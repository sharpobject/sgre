...
function skin.DrawButton(object)
	...
	skin.OutlinedRectangle(x + 1, y + 1, width - 2, height - 2)
	love.graphics.setColor(bordercolor)
	love.graphics.point(x + 1.5, y + 1.5)
	love.graphics.point(x + 1.5, y + height - 1.5)
	love.graphics.point(x + width - 1.5, y + 1.5)
	love.graphics.point(x + width - 1.5, y + height - 1.5)
