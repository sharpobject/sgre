...
--    table.insert(frames.lobby.game_buttons, button)
    ...
    deck_warn_text:SetText({{color = {215, 0, 0, 255}}, "Active deck is invalid!\nNeeds 31 cards!"})
    deck_warn_text:SetSize(460, 550)
    deck_warn_text:SetFont(load_vera(66))
    deck_warn_text:SetY(40)
    deck_warn_text:SetX(40)
